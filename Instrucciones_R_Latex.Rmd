...
- Latex (en alguna distribución). Recomendado: MikTeX Otros: Tinytex, TeXLive
...
![Instalar desde terminal](D:/GitHub/Economics_Toolkit/Instrucciones R/1.jpg){width=50%}
.  
...
![Instalar desde terminal](D:/GitHub/Economics_Toolkit/Instrucciones R/2.jpg){width=50%}
.

## 4 Instalar MikTeX en MacOS
